...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        ...
        <div class="aut">
            <?php echo (USER_ID != -1 ? HELLO .', <a href="'. a_url('user/profile') .'">'. $user['username'] .'</a> | <a href="'. a_url('user/exit') .'">Выход</a>' : '<a href="'. a_url('user/login') .'">Вход</a> | <a href="'. a_url('user/registration') .'">Регистрация</a>') ?>
        </div>
        ...
        <div class="main">
            ...
            <?php echo ads_manager::get_ads_block('all_pages_up', '<div class="rekl">', '</div>') ?>
<?php $this->display('header.tpl', array('sub_title' => 'Мобильные блоги')) ?>
...
<?php $this->display('title.tpl', array('text' => 'Записи <a href="'. URL .'profile/'. $profile['username'] .'">'. $profile['username'] .'</a>')) ?>
...
<div class="block">
    Ссылка на блог:<br />
    <input type="text" value="<?php echo URL .'profile/'. $profile['username'] ?>/blog" />
</div>

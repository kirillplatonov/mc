...
<div class="box">
    <div class="inside">
        <p>
            ...
            <a href="<?php echo a_url('downloads/admin/file_upload', 'directory_id='. $directory['directory_id']) ?>">Загрузить файл в текущую директорию</a><br />
            <?php if($directory['directory_id'] > 0): ?>
            <a href="<?php echo a_url('downloads/admin/ftp_upload', 'directory_id='. $directory['directory_id']) ?>">Загрузить файлы по ФТП в текущую директорию</a><br />
            <?php endif; ?>
        </p>
    </div>
</div>
...
<table cellspacing="0" cellpadding="0" class="table">
    ...
    <tbody>
        ...
        <tr>
            <td><img src="<?php echo URL ?>modules/downloads/views/admin/images/<?php echo $file['type'] ?>.png" /></td>

...
<table cellspacing="0" cellpadding="0" class="table">
    ...
    <tbody align="left" valign="middle">
        ...
        <tr>
            ...
            <td><a href="#" onclick="if (confirm('Вы действительно хотите удалить этот смайл?'))
                   {parent.location='<?php echo a_url('format/admin/smile_delete', 'smile_id='. $smile['smile_id']) ?>';}">Удалить</a></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
</table>
